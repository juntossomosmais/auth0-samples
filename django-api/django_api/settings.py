...
from django_api.apps.core.apps import CoreConfig
from django_api.apps.ssl.apps import SSLConfig
from django_api.support.django_helpers import eval_env_as_boolean
from django_api.support.django_helpers import getenv_or_raise_exception
...
###############################
# Custom settings: Fernet
FERNET_KEY = getenv_or_raise_exception("FERNET_KEY")
